			...
			<table class="table">
				...
				if ($result->num_rows > 0) {
					...
					while($row = $result->fetch_assoc()) {
						...
						echo "<td>".$row["date"]."</td>";
						echo "<td><form action='manager_randc.php' method='post'><button type='submit' class='btn btn-rose btn-round' value='pl_submit' name='pl_submit'>RESCHEDULE</button></form>";
